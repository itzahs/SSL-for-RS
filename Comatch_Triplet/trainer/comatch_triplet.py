""" 
trainer/comatch.py file adapted from Tencent Youtu
[TencentYoutuResearch/Classification-SemiCLS](https://github.com/TencentYoutuResearch/Classification-SemiCLS) repository.

The modifications introduced in this file enhance CoMatch by adding support for deep metric learning (TripletMarginLoss).
"""
...
from spectral import * # added for CoMatch+Triplet
from pytorch_metric_learning import distances, reducers, losses, miners # added for CoMatch+Triplet


class CoMatchTriplet(Trainer):
    ...
    def __init__(self, cfg, device, all_cfg, **kwargs):
        ...
        self.lambda_dml = self.cfg.lambda_dml # added for CoMatch+Triplet
    ...
    def compute_loss(self,
        ...
        Utilizes the [PyTorch Metric Learning](https://kevinmusgrave.github.io/pytorch-metric-learning/) library.
        """
        ...
        #accumulates the derivatives for each pass
        loss.backward()
