""" 
Configuration file adapted from Tencent Youtu
[TencentYoutuResearch/Classification-SemiCLS](https://github.com/TencentYoutuResearch/Classification-SemiCLS) repository.

Adapted for GRSL 
althorithm: CoMatchTriplet
datastet: AID
backbone: resnet18
batch per GPU: 32
num of GPUs: 1
num of labeled data: 40 # 4 labeled samples per class
...
data = dict(
    ...
    mu=7,
    root='/CCSSL/data/AID',
    labeled_names_file='/CCSSL/data/AID/AID_train.txt',
    test_names_file='/CCSSL/data/AID/AID_test.txt',
    lpipelines=[[{
        'type': 'Resize',
        'size': 64
    }, {
