...
data = dict(
    ...
    expand_labels=False,
    mu=7,
    root='/scratch/isequeir/ssl/CCSSL/data/AID',
    labeled_names_file='/scratch/isequeir/ssl/CCSSL/data/AID/AID_train.txt',
    test_names_file='/scratch/isequeir/ssl/CCSSL/data/AID/AID_test.txt',
    lpipelines=[[{
        'type': 'Resize',
        'size': 64
    }, {
